---
name: figma-prep
description: Figma file preparation best practices for Figma-to-Webflow builds. Reference
  before running /figma-audit to ensure the Figma file is structured for clean extraction.
---
...
- **Optional but helpful** — Claude extracts tokens from visual properties (fills, text styles, effects) regardless of whether the designer used Figma variables
...
- Section frames named clearly within each page: `hero`, `about-section`, `testimonials`
...
- Frame widths should match common breakpoints: 1440px (desktop), 991px (tablet), 767px (mobile landscape), 478px (mobile portrait)
...
Before running `/figma-audit`, verify:
